...
public class JDBCPhotoDAO implements PhotoDAO {
	...
	public List<Photo> getAllPhotos() {
		...
		String sql = "SELECT id, unsplash_photo_hash, saved_boolean, file_path FROM unsplash_watcher";
	...
	public List<Photo> getAllSavedPhotos() {
		...
		String sql = "SELECT id, unsplash_photo_hash, saved_boolean, file_path FROM unsplash_watcher WHERE saved_boolean IS TRUE";
		SqlRowSet results = dao.queryForRowSet(sql);
	...
	public List<Photo> getAllUnsavedPhotos() {
		...
		String sql = "SELECT id, unsplash_photo_hash, saved_boolean, file_path FROM unsplash_watcher WHERE saved_boolean IS FALSE";
		SqlRowSet results = dao.queryForRowSet(sql);
...
//		String photogLink = p.getPhotographerLink();
		...
		try {
			SqlRowSet results = dao.queryForRowSet(sql, photoHash, saved, filePath);
			results.next();
